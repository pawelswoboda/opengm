...
#include <opengm/inference/partialOptimality/popt_iri.hxx>
...
int main(){ 
   ...
   typedef IRI::IRI<POpt_DataType,opengm::Minimizer:POpt_IRI_TRWS> POptTypeTRWS;
#ifdef WITH_CPLEX
   typedef IRI::IRI<POpt_DataType,opengm::Minimizer:POpt_IRI_CPLEX> POptTypeCPLEX;
#endif
