...
int main() {
   ...
   minTester.addTest(new GridTest(3, 2, 3, randomLabelSize, true, GridTest::RANDOM, opengm::OPTIMAL, 10));
   ...
   minTester.addTest(new FullTest(5,    5, randomLabelSize, 3,    FullTest::POTTS, opengm::OPTIMAL, 10));
   minTester.addTest(new FullTest(4,    4, randomLabelSize, 2,    FullTest::POTTS, opengm::FAIL, 1));
   minTester.addTest(new FullTest(5,    5, randomLabelSize, 3,    FullTest::RANDOM, opengm::OPTIMAL, 10));
   ...
   minTester2.addTest(new GridTest2(3, 2, 3, randomLabelSize, true, GridTest2::RANDOM, opengm::OPTIMAL, 10));
   ...
   minTester2.addTest(new FullTest2(5,    5, randomLabelSize, 3,    FullTest2::POTTS, opengm::OPTIMAL, 10));
   minTester2.addTest(new FullTest2(4,    4, randomLabelSize, 2,    FullTest2::POTTS, opengm::FAIL, 1));
   minTester2.addTest(new FullTest2(5,    5, randomLabelSize, 3,    FullTest2::RANDOM, opengm::OPTIMAL, 10));
...
//	   typedef opengm::CombiLP<GraphicalModelType2,opengm::Minimizer,TRWSiSolverType> CombiLPType;
//	   CombiLPType::Parameter param;
//	   param.lpsolverParameter_.maxNumberOfIterations_=100;
//	   minTester2.test<CombiLPType>(param);
//   }
